...
public interface ProcessCentricServices {
    ...
    public int initializeUser(
    		...
    		@WebParam(name="user_name") String name);
	
	@WebMethod(operationName="checkGoalStatus")
    @WebResult(name="goal") 
    public GoalStatusResponseContainer checkGoalStatus(
    		@WebParam(name="slack_user_id") String slack_user_id) throws InternalCommunicationException;
	
	@WebMethod(operationName="updateRunInfo")
    @WebResult(name="person") 
    public UpdateRunResponseContainer updateRunInfo(
    		@WebParam(name="slack_user_id") String slack_user_id, 
    		@WebParam(name="distance") Float distance, 
    		@WebParam(name="moving_time") Float time, 
    		@WebParam(name="calories") Float calories) throws InternalCommunicationException;
